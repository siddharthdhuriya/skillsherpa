...
insert into public.courses
  (platform_id, title, slug, category_id, subcategory, description, ai_summary, price_range, price_amount, currency, external_rating, review_count, duration, language, enrollment_link) values
